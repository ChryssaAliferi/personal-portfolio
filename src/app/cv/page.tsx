...
function ExperienceCard({
  ...
  return (
    <div className="relative flex gap-8 pb-12 last:pb-0">
      {/* Timeline line */}
      <div className="absolute left-[7px] top-4 bottom-0 w-px bg-[var(--border)] last:hidden" />
...
function Footer() {
  return (
    <footer className="flex flex-col gap-8 px-20 py-12 bg-[var(--background)] border-t border-[var(--border)]">
      <div className="flex items-center justify-between">
        <Link
          href="/"
          onClick={() => trackEvent("Footer Logo Clicked", { location: "cv" })}
        ...
        <div className="flex gap-4">
          <a
            ...
            className="p-2.5 rounded-lg bg-[var(--surface-tint)] border border-[var(--border)] hover:bg-[var(--surface-muted)] transition-colors"
          >
